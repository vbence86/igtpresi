...
(function(game, toolkit){
    ...
    states.Purchase = {
        ...
        enter: function(){
            ...
            var checkTicketPrice = function () {
                ...
                if(pgc.Game.price ){
                    ticketPrice.innerHTML = "<p>"+pgc.Game.multiCurrencyManager.formatAmount(pgc.Game.price,false,true,1)+",-</p>";
                } else {
                    dots += ".";
    ...
    states.Summary = {
        ...
        enter: function(){
            ...
            setTimeout(function(){
                if(hasInstantWin(game.ScratchZone)) {
                    //clover win
                    PopupHelper.showPopup("bonuswin-popup",true);

                } else if (hasWin(game.ScratchZone)){
                    ...
                    // show win popup animation
                    if (hasBigWin(pgc.Game.Server.Response)) {
